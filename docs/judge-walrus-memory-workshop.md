...
| Relayers | `relayer.staging.memwal.ai` (workshop) · `relayer.memwal.ai` (prod) | [`.env.example`](../.env.example) defaults to **mainnet** relayer |

Canonical SDK docs: [docs.memwal.ai](https://docs.memwal.ai) · LLM index: [llms.txt](https://docs.memwal.ai/llms.txt).
