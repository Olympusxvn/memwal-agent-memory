...
| Resource                                 | Link                                                                                                                                                                                                                                 |
| ---------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Workshop Notion (full guide)             | [https://mystenlabs.notion.site/Walrus-Memory-Workshop-Build-on-the-Memory-Layer-3666d9dcb4e9801dadb0e67ad368235e](https://mystenlabs.notion.site/Walrus-Memory-Workshop-Build-on-the-Memory-Layer-3666d9dcb4e9801dadb0e67ad368235e) |
| Hands-on kit repo                        | [https://github.com/DionisisLougaris/walrus-memory-workshop-kit](https://github.com/DionisisLougaris/walrus-memory-workshop-kit)                                                                                                     |
| Kit SDK reference (`SKILL.md`)           | [https://github.com/DionisisLougaris/walrus-memory-workshop-kit/blob/main/SKILL.md](https://github.com/DionisisLougaris/walrus-memory-workshop-kit/blob/main/SKILL.md)                                                               |
| MemWal repo (canonical)                  | [https://github.com/MystenLabs/MemWal](https://github.com/MystenLabs/MemWal)                                                                                                                                                         |
| Workshop closing survey (Mysten)         | [https://docs.google.com/forms/d/e/1FAIpQLSdNxVFuVipZVjzZH2YDqvf8794i8mFgbXQ2mw9XvgwXNElj6Q/viewform](https://docs.google.com/forms/d/e/1FAIpQLSdNxVFuVipZVjzZH2YDqvf8794i8mFgbXQ2mw9XvgwXNElj6Q/viewform)                           |
...
| Docs                                     | [https://docs.wal.app](https://docs.wal.app) (Walrus Memory)                                                                                                                                                                         |
| Dashboard **testnet** (workshop default) | [https://staging.memory.walrus.xyz](https://staging.memory.walrus.xyz)                                                                                                                                                               |
| Dashboard **mainnet** (live MemWal push) | [https://memory.walrus.xyz](https://memory.walrus.xyz)                                                                                                                                                                               |
| npm SDK                                  | [https://www.npmjs.com/package/@mysten-incubation/memwal](https://www.npmjs.com/package/@mysten-incubation/memwal)                                                                                                                   |
| Workshop recording                       | [https://www.youtube.com/watch?v=GncjVUEJw9Y](https://www.youtube.com/watch?v=GncjVUEJw9Y)                                                                                                                                           |
...
**One line for Deepsurge:** *Built on official Walrus Memory primitives from the Overflow workshop; extended with verifiable hybrid memory, judge-ready MCP, and mainnet Sui Move marketplace.*
...
| ----------------- | ---------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| Dashboard         | [https://staging.memory.walrus.xyz](https://staging.memory.walrus.xyz) | [https://memory.walrus.xyz](https://memory.walrus.xyz) (when using live MemWal) |
...
| **Dashboard**               | ~1 min | [https://memwalpp-dashboard.vercel.app/](https://memwalpp-dashboard.vercel.app/)                   | UI + on-chain story                                      |
