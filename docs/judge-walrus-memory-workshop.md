...
| Hands-on kit repo | https://github.com/DionisisLougaris/memwal-workshop-kit |
...
| Dashboard **testnet** (workshop default) | https://staging.memwal.ai |
| Dashboard **mainnet** (this submission demo) | https://memwal.ai |
...
| **C. Permissions dashboard** | Control plane on Sui (delegates), separate from relayer | **Stronger story:** mainnet package + delegate bridge + explorer IDs in [`docs/deploy.md`](deploy.md); dashboard for wallet owners at memwal.ai |
...
|---|----------------|----------------------------|
| Dashboard | https://staging.memwal.ai | https://memwal.ai (when using live MemWal) |
| Relayer | `https://relayer.staging.memwal.ai` | `https://relayer.memwal.ai` (see [`.env.example`](../.env.example)) |
...
| **Workshop kit** (optional) | ~5 min | Clone [memwal-workshop-kit](https://github.com/DionisisLougaris/memwal-workshop-kit) | Official SDK only — **not** required for this submission |
